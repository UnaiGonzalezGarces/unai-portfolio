          ...
          <div className='flex items-center gap-2 mt-auto'>
            {socialLinks.map(({ href, icon }, key) => (
              <a
                key={key}
                href={href}
                className='grid w-12 h-12 place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color, color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80'
                target='_blank'
              >
                {icon}
              </a>
            ...
            <ButtonPrimary
              href='mailto:unai.392@gmail.com'
              label='Mail me'
              icon='chevron_right'
            />
          </div>
...
//                 autoComplete='email'
//                 required
//                 placeholder='unaigonzalez@gmail.com'
//                 className='text-field'
//               />
//             </div>
//           </div>
